import { Box, Container , HStack, VStack , Text, Image, Stat, StatLabel, StatNumber, StatHelpText, StatArrow, Badge , Progress, Button} from '@chakra-ui/react';
    ...
    <Container maxW={'container.xl'}>
      {
        loading?<Loader/> : (
          ...
          <HStack p={'4'} overflowX={'auto'}>
            {
              btns.map((i)=>(
                <Button key={i} disa onClick={() => switchChartStats(i)}>{i}</Button>
              ))
            }
          </HStack>
